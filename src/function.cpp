...
Function::Function(const double coefs[5],const double red,const double green,const double blue,const int nonLin){
	for (int i =0;i<6;++i){
		_coefs[i] = coefs[i];
	}
	_red = red;
...
bool Function::operator()(double &x, double &y, double &r, double &g, double &b){
	double ox = x;
	double oy = y;	
