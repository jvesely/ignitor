...
FunctionTab::operator Function() {
  ...
  Function me(coefs, colour.redF(), colour.greenF(), colour.blueF(),
              comboVariations->currentIndex());
  return me;
}
...
int GeneralOptions::getIterations() { return iterationSlider->value(); }
int GeneralOptions::getWidth() { return spinBoxWidth->value(); }
int GeneralOptions::getHeight() { return spinBoxHeight->value(); }
void GeneralOptions::setFuncCount(int n) { functionsCount->setNum(n); }
